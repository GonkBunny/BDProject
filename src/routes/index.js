...
const router = Router();
const {getStatistic, banUser, cancelLeilao, getLeiloes,createUser,Login,criarLeilao,getLeiloesByKeyword, updateLeilao, getLeilaoByID,makeLicitation,  insertMural} = require("../controllers/index.controller");
